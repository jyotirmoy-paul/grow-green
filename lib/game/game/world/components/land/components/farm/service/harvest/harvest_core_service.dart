...
class CropHarvestCoreService implements HarvestCoreService {
  ...
  HarvestModel harvest() {
    return HarvestModel(
      ...
      revenue: MoneyModel(value: 10000), // FIXME probably need Qty calculator
      growable: cropType,
...
class TreeHarvestCoreService implements HarvestCoreService {
  ...
  HarvestModel harvest() {
    ...
    return HarvestModel(
      ...
      yield: 1.0,
      revenue: MoneyModel(value: treeRecurringValue), // FIXME: probably no of trees needs to be considered
      growable: treeType,
      dateOfHarvest: currentDateTime,
  ...
  HarvestModel sell() {
    ...
    return HarvestModel(
      harvestType: HarvestType.oneTime,
      yield: 1.0,
      revenue: MoneyModel(value: treePotentialPrice), // FIXME: probably no of trees needs to be considered
      growable: treeType,
      dateOfHarvest: currentDateTime,
      ageInDaysAtHarvest: treeAgeInDays,
    );
